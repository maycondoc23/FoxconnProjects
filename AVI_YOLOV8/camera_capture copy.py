...
class Principal(QMainWindow):
    def __init__(self):
        ...
        self.btnmask.setVisible(False)  # Desabilita o botão até que a máscara seja definida
    ...
    def atualizar_frame(self):
        ...
        rgb_image = self.frameatual.get_numpy_array()
    ...
    def desenhar_resultado_ia_em_tempo_real(self, img):
        ...
        results = model.predict(img, conf=0.40, verbose=True)[0]
        ...
        for box, cls, conf in zip(results.boxes.xyxy, results.boxes.cls, results.boxes.conf):
            ...
            if label.upper() == "DATAMATRIX":
                ...
                if label in ["Awaiting...", "", " ", "Serial:", "SN:"] or label.strip() == "= PASS":
                    self.testing = False
                    ...
                    label = self.labelserial.text()
                    if not label in ["Awaiting...", "", " ", "Serial:", "SN:"]:
                        self.serialnumber = serial
                        # self.status_componente_botao("DATAMATRIX1", value=100, status="PASS")
            ...
            for nome, info in componentes_esperados.items():
                ...
                if not achou:
                    ...
                    if self.item_botao20_selecionado == nome:
                        ...
                        # Aumenta a espessura da linha do retângulo para 6
                        # cv2.rectangle(img, (falt_x1, falt_y1), (falt_x2, falt_y2), (255, 0, 0), 17)

                    if classe in classe_exibiba:
                        pass
                    else:
                            ...
                            if distancia(pos, centro_box(box)) < 50:
                                ...
                                if comparacao is not None:
                                    try:
                                        ...
                                        # selecionar o ultimo item adicionado
                                        # adicionar foto para self.label_imagem_botao20
                                        # Redimensiona a imagem para ocupar toda a altura do label, mantendo o aspecto e centralizando
    ...
    def keyPressEvent(self, event):
        ...
        # verifiacao se a tecla pressionada foi delete 
        ...
        while True:
            try:
                ...
                self.label_imagem.setPixmap(QPixmap.fromImage(qimg).scaled(
                    self.label_imagem.size(), Qt.KeepAspectRatio))
